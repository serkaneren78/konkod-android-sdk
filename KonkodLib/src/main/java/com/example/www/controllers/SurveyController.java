...
public class SurveyController extends BaseController {
     ...
     */
    public void createSurveyPOSTAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    _request = _buildCreateSurveyPOSTRequest(request);
                } catch (Exception e) {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            Survey returnValue = _handleCreateSurveyPOSTResponse(_context);
    ...
    /**
     * Builds the HttpRequest object for createSurveyPOST
     */
    private HttpRequest _buildCreateSurveyPOSTRequest(
                final Survey request) throws IOException, APIException {
        //the base uri for api requests
        String _baseUri = Configuration.getBaseUri();

        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/api/v1/survey");
    ...
    /**
     * Processes the response for createSurveyPOST
     * @return An object of type void
     */
    private Survey _handleCreateSurveyPOSTResponse(HttpContext _context)
        ...
        Survey _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<Survey>(){});
